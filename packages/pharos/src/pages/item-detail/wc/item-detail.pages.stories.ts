...
export const ItemDetail = (): TemplateResult => html`
  <div class="item-detail-page__container">
    ${HeaderRevised(true)}
    <main class="item-detail-page__container--main-content">
      <div class="item-detail-page__container--top">
      ...
      <div class="item-detail-page__container--body">
        <div class="item-detail-page__grid--body">
