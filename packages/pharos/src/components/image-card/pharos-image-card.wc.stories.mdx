...
export const PromotionalTemplate = () => html`<pharos-layout style="margin: 1rem 0">
  <div class="image-card-example__card--promotional">
    <pharos-image-card title="Bring your work to life with images" link="#" variant="promotional">
      <img src="./images/item-detail/tall_image.png" alt="" slot="image" />
      <p slot="metadata">
...
export const SubtleSelectable = () => html`<pharos-layout tag="ol" style="margin: 1rem 0">
  <li style="grid-column: span 3">
    <pharos-image-card
      title="Selectable"
      link="#"
...
<Canvas>
  <Story name="Subtle Selectable">{SubtleSelectable.bind({})}</Story>
</Canvas>
