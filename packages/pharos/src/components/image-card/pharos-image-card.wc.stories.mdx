...
export const Template = (args) => html`<pharos-layout style="margin: 1rem 0"
  ><pharos-image-card
    ...
    ?subtle-select=${args.subtleSelect}
...
# Subtle State With Selection

<Canvas>
  <Story name="Selectable Subtle State" args={{ subtle: true, variant: 'selectable' }}>
    {Template.bind({})}
  </Story>
</Canvas>

# Subtle State With Subtle Selection

<Canvas>
  <Story
    name="Subtle Selectable on Subtle State"
    args={{ subtle: true, variant: 'selectable', subtleSelect: true }}
  >
    {Template.bind({})}
  </Story>
</Canvas>
