...
<Canvas withToolbar>
  <Story name="Icons Only">
    {html`
      <pharos-toggle-button-group>
        <pharos-toggle-button icon="view-list"></pharos-toggle-button>
        <pharos-toggle-button icon="view-gallery"></pharos-toggle-button>
        <pharos-toggle-button icon="image"></pharos-toggle-button>
      </pharos-toggle-button-group>
    `}
  </Story>
</Canvas>
