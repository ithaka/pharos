...
<PharosLink href="https://www.jstor.org/pharos/components/textarea" target="_blank">
...
<Canvas withToolbar>
  <Story name="States">
    ...
    >
      ...
      >
        <span slot="label">I am read-only</span>
      </PharosTextarea>
      <PharosTextarea
        placeholder="Enter some text"
        style={{
      ...
      >
        <span slot="label">I can't be resized</span>
      </PharosTextarea>
    </div>
  </Story>
</Canvas>
