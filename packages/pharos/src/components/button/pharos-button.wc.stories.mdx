...
import { iconNames } from '../icon/pharos-icon';
...
<pharos-link href="https://www.jstor.org/pharos/components/button" target="_blank">See guidelines in Pharos</pharos-link>
...
<Canvas withToolbar>
  <Story name="Variants">
    {html`
      <div
        style="display: grid; display: -ms-grid; grid-gap: 2rem; grid-template-columns: repeat(3, 200px); -ms-grid-columns: 200px 2rem 200px 2rem 200px"
      >
        <div
          style="padding: 1rem; display: grid; grid-gap: 1.5rem; -ms-grid-column: 1; -ms-grid-row: 1;"
        >
        ...
        <div
          style="padding: 1rem; display: grid; grid-gap: 1.5rem; -ms-grid-column: 1; -ms-grid-row: 2;"
        >
        ...
        <div
          style="background-color: #000000; padding: 1rem; display: grid; grid-gap: 1.5rem; -ms-grid-column: 1; -ms-grid-row: 3;"
        >
