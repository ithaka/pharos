...
<pharos-link href="https://www.jstor.org/pharos/components/text-input" target="_blank">See guidelines in Pharos</pharos-link>
  ...
  <Story name="States">
    {html`
      ...
      >
        ...
        <pharos-text-input disabled><span slot="label">Disabled input</span></pharos-text-input>
        <pharos-text-input readonly value="Example text"
          ><span slot="label">Read only input</span></pharos-text-input
        >
        <pharos-text-input placeholder="example placeholder text"
          ><span slot="label">Placeholder for input</span></pharos-text-input
        >
        <pharos-text-input value="This value was provided"
          ><span slot="label">Value provided</span></pharos-text-input
        >
        <pharos-text-input hide-label value="Hidden label input"
          ><span slot="label">Hidden label</span></pharos-text-input
        >
        <pharos-text-input value="A validated value" validated
