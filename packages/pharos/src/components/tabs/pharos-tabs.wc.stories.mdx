...
<pharos-link href="https://www.jstor.org/pharos/components/tabs" target="_blank">See guidelines in Pharos</pharos-link>
    ...
    {html`
      <pharos-tabs>
        ...
        <pharos-tab-panel id="panel-3" slot="panel"
          >I am the panel for tab 3 but listed 2rd in the DOM</pharos-tab-panel
        >
