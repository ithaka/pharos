...
import type { ButtonType, IconName, ButtonVariant, ButtonAlignment } from '../button/pharos-button';

export type { LinkTarget, ButtonType, IconName, ButtonVariant, ButtonAlignment };
