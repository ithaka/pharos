...
export const States = {
  render: () => html`
    <div style="display: grid; grid-gap: 7rem; grid-template-columns: repeat(2, 300px);">
      <storybook-pharos-multiselect-dropdown name="default">
      ...
      <storybook-pharos-multiselect-dropdown name="placeholder" placeholder="Enter some text">
        <span slot="label">I have a placeholder</span>
        <option value="1">Option 1</option>
        <option value="2">Option 2</option>
        <option value="3">Option 3</option>
      </storybook-pharos-multiselect-dropdown',>
      <storybook-pharos-multiselect-dropdown name="provided" value="2">
        <span slot="label">I have a value provided</span>
        <option value="1">Option 1</option>
        <option value="2">Option 2</option>
        <option value="3">Option 3</option>
      </storybook-pharos-multiselect-dropdown',>
      <storybook-pharos-multiselect-dropdown name="hidden" hide-label>
