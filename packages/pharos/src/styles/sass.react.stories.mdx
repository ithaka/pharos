    ...
    if (element.indexOf(':') != -1) {
      ...
      return (
        <div key={index} style={{ backgroundColor: '#F5F5F5' }}>
          <code style={{ color: 'blue', backgroundColor: '#F5F5F5' }}>{property}</code>
          <code style={{ backgroundColor: '#F5F5F5' }}>{remaining}</code>
          <br />{' '}
        </div>
      );
    } else {
      return (
        <div key={index} style={{ backgroundColor: '#F5F5F5' }}>
          <code style={{ backgroundColor: '#F5F5F5' }}>{element}</code> <br />
        </div>
      );
    }
  });
