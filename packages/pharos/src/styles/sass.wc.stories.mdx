...
export const renderCssAttributes = (attributes) => {
  let cssHTML = attributes.map((element) => {
    if (element.indexOf(':') != -1) {
      ...
      return html` <code
          style="color:var(--pharos-color-jstor-red); background-color:var(--pharos-color-marble-gray-97); font-size:var(--pharos-font-size-micro);"
          >${property}</code
        ><code
...
export const PharosMixins = () => html`
  ${TokenTable(
    ...
    html`
      ...
      <tbody>
        ${Object.keys(sass_values.mixins).map((key) => {
          if (sass_values.mixins[key].category == 'Buttons') {
            return html`
              <tr>
    ...
    html`
      ...
      <tbody>
        ${Object.keys(sass_values.mixins).map((key) => {
          if (sass_values.mixins[key].category == 'Form elements') {
            return html`
              <tr>
                <td>${toTokenFormat(sass_values.mixins[key].name)}</td>
                <td>${sass_values.mixins[key].usage}</td>
    ...
    html`
      ...
      <tbody>
        ${Object.keys(sass_values.mixins).map((key) => {
          if (sass_values.mixins[key].category == 'Interaction') {
            return html`
              <tr>
                <td>${toTokenFormat(sass_values.mixins[key].name)}</td>
                <td>${sass_values.mixins[key].usage}</td>
    ...
    html`
      ...
      <tbody>
        ${Object.keys(sass_values.mixins).map((key) => {
          if (sass_values.mixins[key].category == 'Layout') {
            return html`
              <tr>
                <td>${toTokenFormat(sass_values.mixins[key].name)}</td>
                <td>${sass_values.mixins[key].usage}</td>
    ...
    html`
      ...
      <tbody>
        ${Object.keys(sass_values.mixins).map((key) => {
          if (sass_values.mixins[key].category == 'Links') {
            return html`
              <tr>
                <td>${toTokenFormat(sass_values.mixins[key].name)}</td>
                <td>${sass_values.mixins[key].usage}</td>
    ...
    html`
      ...
      <tbody>
        ${Object.keys(sass_values.mixins).map((key) => {
          if (sass_values.mixins[key].category == 'Typography') {
            return html`
              <tr>
                <td>${toTokenFormat(sass_values.mixins[key].name)}</td>
                <td>${sass_values.mixins[key].usage}</td>
