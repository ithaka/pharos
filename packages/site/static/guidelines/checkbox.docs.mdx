...
<Canvas>
  <pharos-checkbox required invalidated message="This field is required, please make a selection">
    <span slot="label">Checkbox label</span>
  </pharos-checkbox>
</Canvas>
...
<Canvas>
  <pharos-checkbox indeterminate checked>
    <span slot="label">Checkbox label</span>
  </pharos-checkbox>
</Canvas>
