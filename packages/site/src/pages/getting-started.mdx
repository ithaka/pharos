...
> Developers using Pharos in React should import from `@pharos/core/lib/react-components/` <br />
> Otherwise, imports are from `@pharos/core/lib/components/`
...
```jsx
import { PharosButton } from "@pharos/core/lib/react-components/button/pharos-button";
  ...
...
<script>
  import "@pharos/core/lib/components/button/pharos-button";
  ...
</script>
...
To use the correct fonts, start by importing them by importing `@pharos/core/lib/styles/fonts.css` at the top level of your web app.
Once imported, set the root body font and styles by importing `@pharos/core/lib/styles/typography.scss`. If there are places
...
<script>
  ...
  import "@pharos/core/lib/styles/typography.scss";
  ...
</script>
...
To start using the design tokens, import the `@pharos/core/lib/styles/_variables.scss` file and use the desired token in the styles for
