  ...
  <ul class="list-example__no-bullets">
    <li style="display: flex; color: var(--pharos-color-green-base);">
      <site-pharos-icon
        name="checkmark"
        class="checkmark"
        style="margin-right: var(--pharos-spacing-one-half-x); fill: var(--pharos-color-green-base);"
    ...
    <li style="display: flex; color: var(--pharos-color-living-coral-53);">
      <site-pharos-icon
        name="close"
        class="close"
        style="margin-right: var(--pharos-spacing-one-half-x; fill: var(--pharos-color-living-coral-53);"
