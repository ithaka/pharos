...
<div style={{ marginBottom: 'var(--pharos-spacing-5-x)' }}>
  ...
  typography styles for the product, see our <PharosLink href="https://pharos.jstor.org/brand-expressions/typography">typography brand expression page.</PharosLink>
</div>
