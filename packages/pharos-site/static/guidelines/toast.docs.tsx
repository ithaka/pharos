    ...
    <>
      ...
      <PageSection topMargin title="Usage">
        <p>
          ...
          might show a toast to inform the user that their recent action of saving an item to the
          workspace was successful.
        </p>
      </PageSection>{' '}
      <PageSection title="Best practices">
        <BestPractices
          Do={
            <ul>
              <li>
                Use for short messages to confirm an action as feedback to the user. For example,
                you might show a toast message to inform a user that their recent action was
                successful
              </li>
              <li>
                Toasts should be concise, scannable and informative—users shouldn't need to spend a
                lot of time figuring out which action they just took and where they could go next
                (e.g., iew in workspace)
              </li>
              <li>States: Can be used specifically for success and error messages</li>
              <li>
                Display toasts one at a time, the newest toasts should appear above the most
                recently displayed toasts
              </li>
          ...
          Dont={
            <ul>
              ...
              <li>
                Not to be used for system errors, outages, etc. Use an alert or banner for these
                needs.
              </li>
            </ul>
          }
      ...
      <PageSection title="Content guidelines">
        <PageSection subSectionLevel={1} title="Toast messages">
          <PageSection subSectionLevel={2} title="Success">
            <p>
              Toast messages are simple, concise and human-sounding. The message informs the user of
            ...
            <p>
              Avoid unnecessary terms, for example, don't use "successfully" in banners that confirm
              an action has been completed, the success toast variant will suffice.
            </p>
          </PageSection>
          <PageSection subSectionLevel={2} title="Error">
            <p>
              When a user experiences an error, it should include an actionable step that the user
              can take on their own or seek help from support.
            </p>
          </PageSection>
        </PageSection>
      </PageSection>{' '}
      ...
      <PageSection title="Accessibility">
        ...
        <PageSection subSectionLevel={1} title="Code expectations">
          <ul>
            <li>
              Toasts should be wrapped in aria-live-region and have <code>role="alert"</code>,
              having both maximizes cross-browser compatibility and assistive technology pairings
            </li>
          ...
          <PageSection subSectionLevel={2} title="Keyboard">
            <ul>
              <li>
                ...
                <ul>
                  <li>
                    When toast is open, the first tab goes to first the first intractable element in
                    the toast notification
                  </li>
                  <li>
                    After it is closed, focus will be placed on the element after the one that
                    triggered the toast
                  </li>
                </ul>
              </li>
