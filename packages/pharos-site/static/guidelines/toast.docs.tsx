...
<>
    ...
    <BestPractices
      Do={
        <ul>
          ...
          <li>
            Toasts should be concise, scannable and informative—users shouldn't need to spend a lot
            of time figuring out which action they just took and where they could go next (e.g., iew
            in workspace)
          </li>
  ...
  <PageSection title="Accessibility">
    ...
    <PageSection subSectionLevel={1} title="Code expectations">
      <ul>
        <li>
          Toasts should be wrapped in aria-live-region and have <code>role="alert"</code>, having
