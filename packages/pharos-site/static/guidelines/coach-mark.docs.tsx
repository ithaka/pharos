...
<>
  ...
  >
    ...
    <PageSection title="Placement" subSectionLevel={1}>
      <p>
        ...
        right of the target (e.g. button, icon, link, etc.) and the caret (triangle) can be placed
        at the start, center or end of the coach mark.
      </p>
      <p>
  ...
  <PageSection title="Content guidelines">
    <p>
      ...
      should Include the minimum amount of information that users need to know. It should not repeat
      what is already visibly available to the user in the interface. For example, you should not
      use "Workspace" as a headline if the coach mark is targeting a "Workspace" navigation link.
      Rather you would expect something actionable like.. "Find what you saved". Content should be
      written in sentence case. Refer to
