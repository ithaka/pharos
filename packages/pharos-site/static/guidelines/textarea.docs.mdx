...
<PageSection title="Usage">
  <p>
    ...
    adding a description, creating a note and more. If an input requires users to write longer forms
    of text, use a textarea instead of a single text input field.
  </p>
</PageSection>
...
<PageSection title="Best practices">
  <BestPractices
    Do={
      <ul>
        <li>Labels should clearly indicates input expectations of the user</li>
