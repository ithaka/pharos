    ...
    <BestPractices
      Do={
        <ul>
          ...
          <li>
            Place pagination below the set of items it paginates through, aligned to the right side
  ...
  <PageSection title="Accessibility">
    ...
    <PageSection title="Code expectations" subSectionLevel={1} lessMargin>
      <ul>
        ...
        <li>
          <code>&lt;nav&gt;</code> should also have a <code>role="navigation"</code> to ensure that
          all assistive technologies will be given the information
        </li>
        <li>
    ...
    <PageSection title="Expected actions" subSectionLevel={1} lessMargin>
      <div style={{ marginBottom: 'var(--pharos-spacing-1-x)' }}>
        ...
        <ul>
          <li>Reads "Pagination navigation, go to (previous/next) page 1, list 1 of X, link"</li>
        </ul>
      </div>
      <PharosHeading level={'4'} preset={'1--bold'}>
        Keyboard
