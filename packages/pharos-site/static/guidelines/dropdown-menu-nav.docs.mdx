...
>
  <PharosLink
    href="http://pharos-storybooks.apps.test.cirrostratus.org/wc/?path=/story/components-dropdown-menu-nav--base"
    target="_blank"
  >
    See in Storybook
  </PharosLink>
...
>
  ...
  <PageSection isSubsection title="Expected actions">
    <PageSection
      isSubsubsection
      title="Screen reader"
      description='Reads "dropdown name, collapsed, menu item"'
    />
    <PageSection isSubsubsection title="Keyboard">
      <ul>
        <li>
