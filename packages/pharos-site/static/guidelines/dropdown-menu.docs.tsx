...
<>
  ...
  <PageSection topMargin title="Usage">
    <p>
      ...
      dropdown menu can be triggered by matching the <code>data-dropdown-menu-id</code> on an
      element to the <code>id</code> of the dropdown menu. They are best used when more than two
      options are presented to the user, and can also be used to organize content.
    </p>
  </PageSection>{' '}
  ...
  <PageSection title="Accessibility">
    ...
    <PageSection title="Keyboard" subSectionLevel={1}>
      <ul>
        ...
        <li>
          <kbd>&#8594;</kbd> <kbd>&#8592;</kbd>: moves focus left and right if there is more than
          one dropdown (such as the global navigation on JSTOR)
        </li>
        <li>
