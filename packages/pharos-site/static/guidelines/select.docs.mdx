...
<PageSection title="Usage">
  <p>
    Select is a type of input that's used in forms to allow users to submit data from a list of
    options. Although the select component itself is styled to align with the brand, the options
    component within it are left to be styled by the browser.
  </p>
</PageSection>
...
<PageSection title="Best practices">
  ...
  <BestPractices
    ...
    Dont={
      <ul>
        <li>Don't use a select for navigational related needs, a dropdown menu will suffice</li>
