...
<>
    ...
    <BestPractices
      Do={
        <ul>
          ...
          <ul>
            <li>
              Use the section sub component when trying to create groupings of menus and link that
  ...
  <PageSection title="Content guidelines">
    <p>
      ...
      of links pertaining to that group. Also, use sentence case for primary and secondary
      navigation items.
    </p>
  </PageSection>{' '}
  ...
  <PageSection title="Variants">
    <PageSection subSectionLevel={1} title="Mobile">
      <p>
        ...
        lower than 1056 pixels. In order to show the menu again, use the button sub-component for a
        manual toggling experience. The navigation appears over the top of the content with an
        overlay over the underlying content.
      </p>
      <Canvas>
