...
<>
  ...
  <PageSection title="Accessibility">
    ...
    <PageSection subSectionLevel={1} title="Importance">
      <ul>
        <li>
          Combo boxes are used as a text field that has a list of pre-populated dropdown options.
          For this specific example, we are looking at a combobox with autocomplete.
        </li>
      </ul>
    </PageSection>
    <PageSection subSectionLevel={1} title="Code expectations">
      <ul>
        ...
        <li>
          ...
          <code>aria-activedescendant</code> and <code>aria-hidden</code> properties on the nested
          elements depending on the current state of the component and its options.
        </li>
        <li>
