  ...
  ```{' '} */}
        ...
        <PageSection title="Overview" subSectionLevel={1} lessMargin>
          <div style={{ marginBottom: 'var(--pharos-spacing-3-x)' }}>
            <p>
              ...
              complete a task. Modals are meant to purposely interrupt a user's workflow and should
              be used sparingly to limit disruption to the user experience.
            </p>
            <p>
      ...
      <PageSection title="Content guidelines">
        ...
        <PageSection title="Modal footer" subSectionLevel={1} lessMargin>
          ...
          include further pertinent/relevant information. For buttons, use descriptive words such as
          "Add," and Save.
        </PageSection>
      </PageSection>{' '}
      ...
      <PageSection title="Accessibility">
        ...
        <PageSection title="Importance" subSectionLevel={1} lessMargin>
          ...
          user control when they would like to view this modal, this gives them the freedom to
        ...
        <PageSection title="Code expectations" subSectionLevel={1} lessMargin>
          ...
          <ul>
            <li>
              ...
              accessed. No element behind the modal overlay should be in the tab index or accessible
              to screen readers for as long as the modal is visible. We can achieve this by using a
              focus trap.
            </li>
            ...
            <ul>
              <li>
                The title or purpose of the element should contain the "id" that is being referenced
