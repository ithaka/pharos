...
<PageSection title="Content guidelines">
  <PageSection title="Label" isSubsection>
    <ul>
      <li>
  ...
  <PageSection title="Item" isSubsection>
    <ul>
...
<PageSection title="States">
  <PageSection title="Item" isSubsection>
    <div>
      ...
      <Canvas>
        <pharos-dropdown-menu-item>Default</pharos-dropdown-menu-item>
      </Canvas>
    </div>
    <div>
      <pharos-heading level="4" preset="1--bold">
      ...
      <Canvas>
        <pharos-dropdown-menu-item disabled>Disabled</pharos-dropdown-menu-item>
      </Canvas>
    </div>
    <div>
      <pharos-heading level="4" preset="1--bold">
      ...
      <Canvas>
        <pharos-dropdown-menu-item selected>Selected</pharos-dropdown-menu-item>
      </Canvas>
    </div>
  </PageSection>
</PageSection>
...
<PageSection title="Accessibility">
  <ul>
    ...
    <li>
      <pharos-link href="https://www.w3.org/WAI/tutorials/menus/flyout/">
        W3 - Fly-out Menus
      </pharos-link>
    </li>
  </ul>
  ...
  <PageSection title="Visual expectations" isSubsection>
  ...
  <PageSection title="Screen reader" isSubsection>
    <ul>
      <li>Reads "dropdown name, collapsed, menu item"</li>
    </ul>
  </PageSection>
  <PageSection title="Keyboard" isSubsection>
    <ul>
      <li>
