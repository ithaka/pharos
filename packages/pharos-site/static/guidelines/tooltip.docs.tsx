...
<>
  ...
  <PageSection title="Best practices">
    <BestPractices
      Do={
        <ul>
          <li>
            Use tooltips to clarify expected behavior when interacting with icon buttons, buttons,
            or links with an associated keyboard shortcut.
          </li>
          <li>
            Use tooltips sparingly. If you're building something that requires a lot of tooltips,
            work on clarifying the design and the language in the experience. Do you NEED a tooltip?
          </li>
        </ul>
      }
      Dont={
  ...
  <PageSection title="Accessibility">
    ...
    <PageSection subSectionLevel={1} title="Importance">
      ...
      visually. Tooltips can take multiple forms, such as a label for an icon (similar to our
      metadata icon on the item page) or providing additional information or clarification about an
      element (usually in the form of a "i" or a "?" icon). Tooltips do not need to receive focus,
      but rather just live on the button, link or form field that it relates to. There may be
      additional Aria tags that need to be added to make the tooltip available to assistive
      technologies, such as aria-describedby.
    </PageSection>
