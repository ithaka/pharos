...
<PharosFooter>
  ...
  <ul slot="links-group">
    <li>
      <PharosLink id="labs-link" onBackground subtle href="https://labs.jstor.org/" target="_blank">
        JSTOR Labs
      </PharosLink>
    </li>
    <li>
  ...
  <span id="misson-text" slot="mission-statement">
    ...
    <PharosLink onBackground href="https://www.ithaka.org">
      ITHAKA
    </PharosLink>, a not-for-profit organization helping the academic community use digital technologies
  ...
  <span id="copyright-text" slot="copyright-statement">
    ...
    JPASS&reg;, Artstor&reg;, Reveal Digital&trade; and ITHAKA&reg; are registered trademarks of
    ITHAKA.
  </span>
  <ul slot="legal-links">
    <li>
