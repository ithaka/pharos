...
<>
  ...
  >
    <PageSection title="Alignment" subSectionLevel={1}>
      <p>
        ...
        the options can be vertically or horizontally stacked, depending on the use case and UI
        needs. Vertically stacking the checkboxes is preferable for better readability.
      </p>
    </PageSection>
  ...
  <PageSection title="Accessibility">
    ...
    <PageSection subSectionLevel={1} title="Importance">
      ...
      filter. A checkbox grouping also will typically allow users to select more than one item in
      the grouping.
    </PageSection>
    <PageSection subSectionLevel={1} title="Code expectations">
      <ul>
        ...
        <li>
          When the checkbox is selected, the ARIA state is set to <code>aria-checked="true"</code>{' '}
        ...
        <li>
          Some assistive technology reads the legend text for each fieldset, so it should be brief
          and descriptive. This helps someone using assistive technology to understand the question
          they are answering with the group of checkboxes
        </li>
      </ul>
    </PageSection>
