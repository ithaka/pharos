...
<Canvas>
  <pharos-text-input required invalidated message="This field is required">
    <span slot="label">Text input label</span>
  </pharos-text-input>
</Canvas>
...
<Canvas>
  <pharos-text-input required value="I have text" validated>
    <span slot="label">Text input label</span>
  </pharos-text-input>
</Canvas>
