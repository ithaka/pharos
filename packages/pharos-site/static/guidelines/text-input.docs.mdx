...
<PageSection title="Accessibility">
  ...
  <PageSection subSectionLevel={1} title="Accessibility best practices for labes:">
    <ul>
  ...
  <PageSection subSectionLevel={1} title="Code expectations">
    ...
    *NOTE: If the text input is a required field include the aria-required property and indicate that
    it is a required field. Use the validation message for input errors
  </PageSection>
