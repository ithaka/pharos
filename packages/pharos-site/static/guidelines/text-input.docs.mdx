...
<PageSection title="Usage">
  <p>
    ...
    text input and what value the data will provide.
  </p>
</PageSection>
...
<PageSection title="Content guidelines">
  <PageSection subSectionLevel={1} title="Labels">
    <ul>
      <li>
        The input label needs to help tell the user what is expected of them, but they don't need to
        be instructive
      </li>
...
<PageSection title="Variants">
  ...
  <PageSection subSectionLevel={1} title="Email">
    <p>
      The email variant provides validation to ensure proper formatting of an email address. Use the
      email variant to allow the user to enter or edit an email address to help avoid user typos and
      invalid addresses.
    </p>
    <Canvas>
  ...
  <PageSection subSectionLevel={1} title="Number">
    <p>
      ...
      of up and down buttons are also provided to step the value up and down. On some devices, it
