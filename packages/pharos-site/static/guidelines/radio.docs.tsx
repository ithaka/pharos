    ...
    <PageSection subSectionLevel={1} title="Code expectations">
      <ul>
        ...
        <li>
          ...
          fieldset. It should be brief and descriptive to help someone using assistive technology
          quickly understand the question they are answering with the group of radio buttons.
        </li>
        ...
        <li>
          ...
          <code>true</code>. If it is not checked, it has "aria-checked" set to <code>false</code>.
        </li>
      </ul>
    </PageSection>
