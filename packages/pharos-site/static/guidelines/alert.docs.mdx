...
>
  <PharosLink
    href="http://pharos-storybooks.apps.test.cirrostratus.org/wc/?path=/story/components-alert--base"
    target="_blank"
  >
    See in Storybook
  </PharosLink>
...
<PageSection title="Accessibility">
  ...
  <PageSection subSectionLevel={1} title="Importance">
    <ul>
      <li>
        ...
        role=alert is put onto an element
        <ul>
          <li>
  ...
  <PageSection subSectionLevel={1} title="Code Expectations">
    <ul>
      <li>
        Putting role="alert" can notify users of a error in a form
        <ul>
          <li>This technique is the same as adding aria-live="assertive"</li>
        </ul>
      </li>
      <li>
      ...
      <li>
        ...
        aria-live-region and have role="alert" and aria-live="assertive". In cases where a user has
        taken action (like filling out and submitting a form), the user's attention is required to
        remedy the error.
      </li>
    </ul>
  </PageSection>
