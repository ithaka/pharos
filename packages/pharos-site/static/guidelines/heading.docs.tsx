    ...
    <>
      ...
      <PageSection topMargin title="Usage">
        <p>
          ...
          component allows you to easily select and implement the appropriate heading style for the
          layout and structure of your page.
        </p>
        <p>
        ...
        <p>
          The "level" prop designates the heading level (h1, h2, h3, etc.) needed to create a
          logical information hierarchy. When using assistive technology, users often utilize
          headings to navigate the page's content quickly. Headings must be semantically tagged so
          that a screen reader can both identify headings when reading a page, or pull up a list of
          all the page's headings.
        </p>
        <p>
          The "preset" prop provides specific styles of the heading text to create visual hierarchy
          that allow users to easily scan pages and content. This includes line-height, font-family,
          font-sizes, letter-spacing and font weight.
        </p>
        <PharosHeading level={2} preset={'1--bold'}>
          Related
        </PharosHeading>
        JSTOR uses design tokens to set the typography styling in JSTOR's products. To learn more
        about other typography styles for the product, see our{' '}
        <PharosLink href="/brand-expressions/typography">
          typography brand expression page.
        </PharosLink>
      </PageSection>{' '}
      <PageSection topMargin title="Typeface">
        <p>
          JSTOR's brand utilizes two typefaces: GT America and Ivar Headline. We use a mix of both
          to express our heading styles.
        </p>
      </PageSection>{' '}
      ...
      <div style={{ marginBottom: 'var(--pharos-spacing-5-x)' }}>
        ...
        <p>
          For headings and titles, always try our serif heading presets (Ivar) first because
          elevates the content, beautifies the page, and helps with scannability when paired with
          our sans-serif typeface.
        </p>
        <ul style={{ color: 'black' }}>
          ...
          <li>
            When pairing presets, do not use the same size presets together to create a better
            visual hierarchy.
          </li>
          <li>
      ...
      <PageSection title="Best Practices">
        <BestPractices
          Do={
            <ul>
              <li>
                Include a level number (between 1 and 6) to create semantic hierarchy, all headings
                need to semantically tagged so that a screen reader can identify them when reading a
                page, or be able pull up a list of all the page headings
              </li>
          ...
          Dont={
            <ul>
              <li>
                Don't use heading tags to resize normal text, use our type-scale and font-family
      ...
      <div style={{ marginBottom: 'var(--pharos-spacing-5-x)' }}>
        ...
        <p>
          Headings and subheadings help organize the content. They identify sections and groupings
          of content to make it easy for readers to scan. Headings are also important for
          accessibility, as they are used to navigate the page.
        </p>
        <p>
          The heading and subheadings should provide a glimpse of what is the most important aspect
          of the information that follows. Organize them by level (e.g., level="1" &gt; level="2"
          &gt; level="3") corresponding to the content they're covering (main topic &gt; aspect of
          that topic &gt; finer points).
        </p>
        <p>
      ...
      <div style={{ marginBottom: 'var(--pharos-spacing-5-x)' }}>
        ...
        <div style={{ marginBottom: 'var(--pharos-spacing-3-x)' }}>
          ...
          They provide both an outline and a means of navigation. Without headings, users have to
          step through every single element in turn, to get from one place to another.
        </div>
        <div style={{ marginBottom: 'var(--pharos-spacing-3-x)' }}>
          <PharosHeading level={3} preset={'2'}>
            Visual expectations
          </PharosHeading>
          Color contrast of text to background should use WCAG 2.1 AA standards is 4.5:1, except,
