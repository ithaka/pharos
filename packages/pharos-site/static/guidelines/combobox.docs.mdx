...
<PageSection title="Content Guidelines">
  <PageSection isSubsection title="Labels">
    <ul>
      <li>
...
<PageSection title="Accessibility">
  ...
  <PageSection isSubsection title="Accessibility best practices for labels:">
    <ul>
  ...
  <PageSection isSubsection title="Keyboard interactions">
    <ul>
