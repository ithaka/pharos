...
import { PharosHeading, PharosLink, PharosSelect } from '@ithaka/pharos/lib/react-components';
  ...
  ```{' '} */}
      <PageSection topMargin title="Usage">
        <p>
          ...
          component itself is styled to align with the brand, the options components within it are
          left to be styled by the browser.
        </p>
      </PageSection>{' '}
      <PageSection title="Best practices">
        <p>
          Select is a type of input that is used in forms, where a user is submitting data and
      ...
      <PageSection title="Accessibility">
        ...
        <PageSection subSectionLevel={1} title="Code expectations">
          <ul>
            ...
            <li>
              There is another list of &lt;option&gt; elements with the &lt;select&gt; element on
              its child elements
            </li>
        ...
        <PageSection subSectionLevel={1} title="Expected actions">
          ...
          <PageSection subSectionLevel={2} title="Keyboard">
            <ul>
              ...
              <li>
                <kbd>up</kbd>/<kbd>down</kbd> arrows: moves focus up and down (which expands the
                select)
              </li>
            </ul>
          </PageSection>
