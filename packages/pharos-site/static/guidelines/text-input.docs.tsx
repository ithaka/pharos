...
<>
    ...
    <BestPractices
      Do={
        <ul>
          ...
          <li>
            Placeholder text should be concise, and demonstrate the expected type of data, rather
  ...
  <PageSection title="Variants">
    ...
    <PageSection subSectionLevel={1} title="Number">
      <p>
        The number input provides some functionality used to collect a numerical value. Usually a
        set of up and down buttons are also provided to adjust the value up and down. On some
    ...
    <PageSection subSectionLevel={1} title="Hidden">
      <p>
        A hidden input does not display a value to the user, but is submitted to the server. This
        can be used when you want to include data the user doesn't need to see or edit, such as a
  ...
  <PageSection title="Accessibility">
    ...
    <PageSection subSectionLevel={1} title="Code expectations">
      <ul>
        <li>
          According to
          <PharosLink href="https://www.w3.org/WAI/tutorials/forms/labels/">W3</PharosLink>, there
          are 3 ways to approach input groups:
        </li>
        <li>
          Visual label:
          <ul>
      ...
      <ul>
        <li>
          ...
          <ul>
            <li>
              {' '}
              &lt;label for="fieldname" class="visuallyhideen"&gt;Field name: &lt;/label&gt;{' '}
            </li>
      ...
      *NOTE: If the text input is a required field include the <code>aria-required</code> property
      and indicate that it is a required field. Use the validation message for input errors
    </PageSection>
