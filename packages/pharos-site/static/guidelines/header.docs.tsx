...
<>
  ...
  <PageSection topMargin title="Usage">
    ...
    <p>
      The Pharos Header provides three slots that removes some of the intricacies of laying out
      links and navigation elements: start, center and end. The three slots correspond to the first,
      second and third column of the header, as shown below.
    </p>
    <PharosHeader>
  ...
  <PageSection title="Content guidelines">
    <div style={{ marginBottom: 'var(--pharos-spacing-3-x)' }}>
      ...
      ></PharosHeading>
      <p>
        The content contained in the header can be seen as information pertinent to all facets of
        the site. They generally serve as unifying core functionalities central to the purpose of
        the site. Hence, the header should be placed in a highly visible and consistent position
        shared across pages.
      </p>
      <p>
