  ...
  ```{' '} */}
      <PageSection topMargin title="Usage">
        <p>
          ...
          elements are allowed on a single page, they can not be placed within other header, footer
          or address regions. If a header element is nested inside an article or section region, the
          header is considered a header for that region, not the whole page or site.
        </p>
        <p>
          The Pharos Header provides three slots that removes some of the intricacies of laying out
          links and navigation elements: start, center and end. The three slots correspond to the
          first, second and third column of the header, as shown below.
        </p>
        <PharosHeader>
      ...
      <PageSection title="Best practices">
        <BestPractices
          Do={
            <ul>
              <li>
                Use Pharos dropdown menu nav and their related components for navigation portion of
                the header
              </li>
      ...
      <PageSection title="Content guidelines">
        <div style={{ marginBottom: 'var(--pharos-spacing-3-x)' }}>
          ...
          <p>
            ...
            naturally with the header are the dropdown menu nav, link and input components, as shown
            at the example at the bottom of the page.
          </p>
        </div>
      </PageSection>
