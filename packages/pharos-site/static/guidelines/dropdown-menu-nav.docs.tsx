    ...
    setPageContent(
      <>
        ...
        <PageSection title="Content guidelines">
          <p>
            The navigation menu acts as a table of contents for your site. The content of links
            should reflect this hierarchy. The primary links representing main sections of the site
            should first be listed. If applicable, add submenus to links with additional related
            sections with a list of links pertaining to that group.
          </p>
        </PageSection>
        <PageSection
          title="Accessibility"
        ...
        <a href="...">By Publisher</a>
          ...
          <PageSection subSectionLevel={1} title="Expected actions">
            ...
            <PageSection subSectionLevel={2} title="Keyboard">
              <ul>
                <li>
                  <kbd>Tab</kbd> moves focus onto the dropdown. When dropdown is expanded, focus
                  will go to next menu item
                </li>
                <li>
