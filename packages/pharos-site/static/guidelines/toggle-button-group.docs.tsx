  ...
  <PageSection title="Best practices">
    <BestPractices
      Do={
        <ul>
          <li>
            Group items within a toggle button group that are related and have a logical connection
            to each other
          </li>
          <li>
            Think about whether your toggle button group needs text and an icon, text only, or an
            icon only
          </li>
