    ...
    const content = (
      <PharosLayout preset="1-col--sidenav-comfy" rows="auto min-content" className={footer}>
        ...
        <div className={`${note} ${copyrightStatement}`}>
          &copy;{new Date().getFullYear()} ITHAKA. All Rights Reserved. JSTOR&reg;, the JSTOR logo,
          JPASS&reg;, Artstor&reg;, Reveal Digital&trade; and ITHAKA&reg; are registered trademarks
          of ITHAKA.
        </div>
