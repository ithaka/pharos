...
<>
  ...
  <PageSection title="2. Main point first">
    <p>
      When you are describing a goal and the action needed to achieve it, start the sentence with
      the goal.
    </p>
    <BestPractices
  ...
  <PageSection title="5. Avoid jargon, idioms, and slang">
    <p>
      ...
      "no problem" instead of "you're welcome" can lead to confusion. Jargon and internal
      terminology are also to be avoided.
    </p>
  ...
  <PageSection title="10. Read it aloud">
    <p>
      If it doesn't sound right, it doesn't read right either. It's also a good way to catch typos
      and errors.
    </p>
  </PageSection>
</>;
