...
<>
  ...
  <PageSection title="Alerts" subSectionLevel={1}>
    <p>
      ...
      can take, and whenever possible, how long we expect the issue will take (such as in the case
      of expected updates or maintenance). Use sentence case and appropriate punctuation.
    </p>
  </PageSection>
  ...
  <PageSection title="Error messages" subSectionLevel={1}>
    <p>
      ...
      including a link to the appropriate Support page if available. Don't include error codes in
      the message.
    </p>
    <p>
      If the user made an error, the messaging should provide a reason for the error, a recommended
      next step, and a way to contact us, if needed. If there are multiple errors, summarize them in
      a logical order.
    </p>
    <BestPractices
      Do={
    ...
    />
    <p>
      If the error message is a single sentence, don't add a period at the end. If it is more than
      one sentence, punctuate normally.
    </p>
  ...
  <PageSection title="Headings and subheadings" subSectionLevel={1}>
    <p>
      ...
      content and make it easy for readers to scan. Headings are also important for accessibility,
      as they are used to navigate the page.
    </p>
    <p>
  ...
  <PageSection title="Links" subSectionLevel={1}>
    ...
    <p>
      Don't use "here" or "on this page" as a link. The link text should accurately describe what
      the user can expect when they click the link. It's good practice for accessibility, and it
  ...
  <PageSection title="Lists" subSectionLevel={1}>
    ...
    <BestPractices
      ...
      Dont={
        <Fragment>
          <span>
            We offer collections of the latest book titles in core disciplines that are highly used
            on JSTOR, as listed below:
          </span>
          <ol>
            <li>History</li>
  ...
  <PageSection title="Alt text" subSectionLevel={1}>
    ...
    <p>
      ...
      unless it's necessary to understand the content. If the image is just decorative, leave the
      alt tag blank so screen-readers will skip it.
    </p>
    <BestPractices
