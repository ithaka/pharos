...
<>
  ...
  <PageSection title="Exclamation marks" subSectionLevel={1}>
    <p>
      Use exclamation points sparingly and only for positive messages; never use exclamation marks
      in feature announcements, error messages, or alerts. Also, don't use them more than once in a
  ...
  <PageSection title="Ellipses (...)" subSectionLevel={1}>
    <p>
      ...
      (e.g. "Loading…" "Connecting…" "Uploading…"), and to shorten words when the text gets too long
      (a.k.a. truncation).
    </p>
  </PageSection>
  ...
  <PageSection title="Login, log in, log in to" subSectionLevel={1}>
    <p>
      ...
      action, "login" when describing an account. Also: you "log in to" your JSTOR account, not "log
      into."
    </p>
  </PageSection>
  ...
  <PageSection title="Numbers" subSectionLevel={1}>
    <p>
      ...
      unless the number is the first word in the sentence. In numbers of more than three digits, use
      a comma after every third digit from right to left (e.g. 1,537,000).
    </p>
  </PageSection>
