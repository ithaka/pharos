...
<>
  ...
  <PageSection title="Organization and products" moreTitleSpace>
    ...
    <PageSection title="JSTOR" subSectionLevel={1} lessMargin>
      ...
      <p>
        Don't use jstor.org when you mean JSTOR the service, only use it when you are pointing to
        the page, and always spell the URL in lowercase.
      </p>
    </PageSection>
    ...
    <PageSection title="Artstor" subSectionLevel={1} lessMargin>
      ...
      <p>
        ...
        proper name), which are freely available collections contributed by institutions using JSTOR
        Forum, and Open Artstor, Creative Commons-licensed collections aggregated from museums,
  ...
  <PageSection title="Individual access programs">
    ...
    <PageSection title="JPASS" subSectionLevel={1}>
      <p>
        ...
        Freedom: Southern Africa primary sources collection. When referring to the JPASS program,
        say "JPASS" or "JPASS plans." When referencing an individual's JPASS subscription, refer to
        it as their "JPASS plan."
      </p>
      <BestPractices
  ...
  <PageSection title="Other terms" moreTitleSpace>
    <PageSection title="Collections" subSectionLevel={1}>
      ...
      <p>
        We refer to Open Community Collections as an initiative, and it's composed of collections
        that are made freely available to everyone. The institutions that provide the content are
    ...
    <PageSection title="JSTOR Support" subSectionLevel={1}>
      <p>
        ...
        directing users to get in touch with our support team, say contact JSTOR Support and link
        the full phrase.
      </p>
    </PageSection>
