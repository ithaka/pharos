...
const OverviewPage: FC = () => {
  return (
    <>
      ...
      <p>
        We capture visual design decisions in named entities called _design tokens_.Tokens help us
        avoid using and repeating hard-coded values throughout the code base, which in turn helps
        carry new decisions forward everywhere tokens are used.
      </p>
      ...
      <p>
        <code>
          ...
          [-
          <span style={{ color: 'var(--pharos-color-living-coral' }}>
            &lt;state/variant/name&gt;
          </span>
          ]
        </code>
      ...
      <dl>
        ...
        <div>
          ...
          <dd>
            Describes the attribute the token affects, or adds context about where the token should
            be used.
          </dd>
        </div>
        <div>
          ...
          <dd>
            Defines the name that differentiates the token from others, or the state for which the
            token is used. Whereas preceding segments of a token name help navigate available
            tokens, this segment helps choose a specific token to use.
          </dd>
        </div>
      </dl>
      ...
      <ul>
        ...
        <li>
          <code>
            <span>pharos</span>-
            <span style={{ color: 'var(--pharos-color-night-blue' }}>spacing</span>-
            <span style={{ color: 'var(--pharos-color-glacier-blue' }}>brand</span>-
