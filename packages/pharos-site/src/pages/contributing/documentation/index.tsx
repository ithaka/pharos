...
<>
  ...
  <PageSection title="Writing documentation">
    <PageSection title="Getting started" subSectionLevel={1}>
      <p>
        To get started, use the <PharosLink href={pdf}>documentation template</PharosLink> to ensure
        all needed sections are included and consistent.
      </p>
    </PageSection>
    <PageSection title="Writing guidelines" subSectionLevel={1}>
      ...
      <p>
        ...
        language in all documentation so users experience a seamless transition as they make their
    ...
    <PageSection title="Documentation categories" subSectionLevel={1}>
      ...
      <p>
        Explain appropriate use cases for the component, general guidelines to follow when using,
        and other considerations that should be made in the component's usage.
      </p>
      <PharosHeading level={'4'} preset={'1--bold'}>
        Don'ts
      </PharosHeading>
      ...
      <p>
        Outlines any code needed to successfully implement the component. Semantic elements should
        be indicated with <code>&lt;code&gt;</code> tags for clarity. In addition, include any
        important points pertaining to implementation.
      </p>
      <PharosHeading level={'4'} preset={'1--bold'}>
        Expected actions
      </PharosHeading>
