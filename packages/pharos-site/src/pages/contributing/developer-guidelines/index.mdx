...
<PageSection title="Contribution guidelines for developers" isHeader></PageSection>

<PageSection title="Importance">
  <p>
    ...
    <PharosLink href="https://github.com/signup?ref_cta=Sign+up&ref_loc=header+logged+out&ref_page=%2F&source=header-home">
      create one
    </PharosLink>&nbsp; to join the community.
  </p>
  ...
  <ol>
    <li>
      ...
      request and respond with next steps. If accepted, it will be added to an upcoming milestone.
      When possible, a tentative timeline will be shared to give you an estimate of when to expect
      the release.
    </li>
    <li>
    ...
    <li>
      <strong>Join a discussion:</strong> You can get involved with asking and answering questions,
      sharing updates, and following along with potential decisions in the project's &nbsp;
      <PharosLink href="https://github.com/ithaka/pharos/discussions">
        open communication forum
      </PharosLink>&nbsp; on GitHub.
    </li>
  </ol>
</PageSection>

<PageSection title="The community">
  <PageSection title="Users" subSectionLevel={1}>
    <p>
      Users are those who use Pharos on their site or use the system's &nbsp;
      <PharosLink href="https://pharos.jstor.org/brand-expressions/logos">
        guidelines for expressing
      </PharosLink>&nbsp; the brand on their product.
    </p>
  </PageSection>
  <PageSection title="Contributors" subSectionLevel={1}>
    <p>
      Contributors are anyone who reports a bug, requests a new feature, or makes a change to the
  ...
  <PageSection title="Maintainers" subSectionLevel={1}>
    <p>
      Maintainers are members who are involved with planning milestones, triaging issues, and
      maintaining the repository. This involves labeling, closing, and merging pull requests.
    </p>
  </PageSection>
</PageSection>
...
<PageSection title="The process">
  <ol>
    <li>
      ...
      <ol>
        <li>
          If so, assign yourself to the issue so that others are aware of your intent to address it.
        </li>
        <li>
    ...
    <li>
      ...
      </PharosLink>&nbsp; to learn about contributing code to Pharos.
    </li>
    <li>
      ...
      , fill out the pull request template as best you can, and request review from the <i>
        Pharos maintainers
      </i> team.
    </li>
    <li>
