...
const DevelopmentPage: FC = () => {
  return (
    <>
      ...
      <PageSection title="">
        <p>
          Pharos is a living design system that continues to expand with help from the community.
          We're excited to work with contributors like you to further enrich the system. Discussions
          about issues, bugs, and features for Pharos take place on GitHub. If you don't have a
          GitHub account,{' '}
        ...
        <ol>
          <li>
            <strong>Open an issue or feature request:</strong> The maintainers will review the issue
            or request and respond with appropriate next steps. If accepted, it will be added to an
            upcoming milestone. When possible, a tentative timeline will be shared to give members
            an estimate of when to expect the next release.
          </li>
          <li>
            <strong>Make the change in Pharos:</strong> To make the contribution yourself please
            follow the process outlined below. The maintainers are more than happy to assist and
            support you through the contribution.
          </li>
          <li>
            <strong>Join a discussion:</strong> Community members can get involved with asking or
            helping answer questions, sharing updates, and following along with potential decisions
            in the project's{' '}
      ...
      <PageSection title="The Pharos community">
        <PageSection title="Users" subSectionLevel={1}>
          <p>
            ...
            <PharosLink href="/brand-expressions/logos">system's guidelines</PharosLink> to
            implement Pharos into their product or marketing needs.
          </p>
        </PageSection>
        <PageSection title="Contributors" subSectionLevel={1}>
          <p>
            Contributors are community members who report bugs, request new features, or make
            changes to the system. Changes can include adding a new feature, fixing a bug, or
      ...
      <PageSection title="The process">
        <ol>
          <li>
            ...
            <ol>
              <li>
                If so, please comment on the issue that you'd like to address it so that the
                maintainers are aware of your intent and can assign you.
              </li>
              <li>
          ...
          <li>
            ...
            <ol>
              ...
              <li>
                Chromatic (for Storybook and component related changes) - Takes snapshots of all
                stories in Storybook and compares them against the baseline
              </li>
              <li>
                Netlify preview (for site related changes) - Generates a preview build of the site
                for the maintainers to review and provide feedback
              </li>
            </ol>
          </li>
          <li>
