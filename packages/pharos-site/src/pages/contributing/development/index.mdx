...
<PageSection title="">
  <p>
    {
      <>
        ...
        about issues, bugs, and features for Pharos take place on GitHub. If you don't have a GitHub
        account,
  ...
  <ol>
    <li>
      ...
      request and respond with appropriate next steps. If accepted, it will be added to an upcoming
      milestone. When possible, a tentative timeline will be shared to give members an estimate of
...
<PageSection title="The Pharos community">
  <PageSection title="Users" subSectionLevel={1}>
    <p>
      ...
      <PharosLink href="/brand-expressions/logos">system's guidelines</PharosLink> to implement Pharos
      into their product or marketing needs.
    </p>
  </PageSection>
  <PageSection title="Contributors" subSectionLevel={1}>
    <p>
      ...
      the system. Changes can include adding a new feature, fixing a bug, or updating documentation.
    </p>
  </PageSection>
...
<PageSection title="The process">
  <ol>
    ...
    <li>
      ...
      If you haven't already done so, clone the <PharosLink href="https://github.com/ithaka/pharos">
        repo
      </PharosLink> and create a new branch for your contribution. Review the
    ...
    <li>
      ...
      Follow the <PharosLink href="https://github.com/ithaka/pharos/blob/develop/docs/development/conventions/pull-requests.md">
        guidelines
      </PharosLink>, fill out the pull request template as best you can, and request a review from the
