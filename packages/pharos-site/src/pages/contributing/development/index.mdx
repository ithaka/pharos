  ...
  <PageSection title="Users" subSectionLevel={1}>
    <p>
      ...
      <PharosLink href="https://pharos.jstor.org/brand-expressions/logos">
        system's guidelines
      </PharosLink>&nbsp;to implement Pharos into their product or marketing needs.
    </p>
  </PageSection>
...
<PageSection title="The process">
  <ol>
    ...
    <li>
      ...
      , fill out the pull request template as best you can, and request a review from the <i>
        Pharos maintainers
      </i> team.
    </li>
    <li>
