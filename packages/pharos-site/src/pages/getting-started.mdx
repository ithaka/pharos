...
To register a component, import the classes in your application's entrypoint and define the component with a tag name in the form of `{app/bundle}-pharos-{component}`:
