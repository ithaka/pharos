...
<p>
  ...
  {/* <!--- pretiier-ignore-start --> */}<PharosLink href="https://github.com/ithaka/pharos/blob/main/docs/development/code-structure.md">Code structure</PharosLink>{' '}{/* <!--- pretiier-ignore-stop --> */}
  and{' '}
  {/* <!--- pretiier-ignore-start --> */}  <PharosLink href="https://github.com/ithaka/pharos/blob/main/docs/development/conventions/README.md">Conventions</PharosLink>{' '}{/* <!--- pretiier-ignore-stop --> */}
  .
  {/* <!--- pretiier-ignore-start --> */}<PharosLink href="https://github.com/ithaka/pharos/blob/main/docs/development/anatomy-of-a-component.md">The anatomy of components</PharosLink>{' '}{/* <!--- pretiier-ignore-stop --> */}
