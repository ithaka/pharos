...
<PageSection
  title="Typography"
  description={`We selected two typefaces that represent our brand qualities; they are Ivar a serif to be used primarily for headlines and GT America a sans serif to be used for body copy.`}
  isHeader
>
  <div
    style={{
...
<PageSection title="Headline Typefaces">
  ...
  >
    <strong>Ivar</strong> is influenced by the grace and sturdy construction of Times. The typeface
    stands on the shoulders of giants: the design refers to the dependable text faces from the
    mid-1900s, which in turn were rooted in classic designs from the 16th and 17th century.
  </div>
...
<PageSection title="Principles">
  ...
  <Grid columns={2}>
    ...
    <div>The logo should be used as outlined in this guide on all materials.</div>
  </Grid>
  <Grid columns={2}>
    <div>
      <PharosHeading level="4" preset="1--bold">
