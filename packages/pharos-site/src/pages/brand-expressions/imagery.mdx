...
<PageSection
  title="Imagery"
  description="We have a great opportunity to express who we are through imagery. We are selecting images from two categories, JSTOR images (archive) and brand images."
  isHeader
>
  <Grid columns={1} justifyContent="center" minContent align="end">
    <img src={imageHero} alt="Archive images - Hero" />
  </Grid>
</PageSection>

<PageSection
  title="Image types"
  description="The two main categories of images are Archival and Brand. Archival includes Artstor, Community Collections, Primary Source, Journal and Book covers. Brand images are images of users, research and the places JSTOR is being used."
>
...
<PageSection
  title="Principles"
  description="Visuals are the most immediate aspect of our brand, and we must be mindful of how we select them. Here are some basic guidelines to consider as you pick images for promoting our services and products."
>
  <div style={{ marginBottom: 'var(--pharos-spacing-2-x)' }}>
    ...
    <p style={{ color: 'var(--pharos-color-text-20)' }}>
      Archive images should represent our collections (Artstor, Open Community Collections, Primary
      Sources) as well as the diverse content types in them (art, objects, historical documentation,
      science). When choosing non-western items, take care to look at their intended purpose and not
      just how they look.
    </p>
    <p style={{ color: 'var(--pharos-color-text-20)' }}>
      Images of art or artifacts should represent different cultures and time periods, including
      diversity in the creators (women, non-western). Similarly, images of people should be diverse
      (representing different demographics and abilities).
    </p>
    <p style={{ color: 'var(--pharos-color-text-20)' }}>
      If it's a global or international campaign, make sure the people pictured adhere to dress
  ...
  <div style={{ marginBottom: 'var(--pharos-spacing-2-x)' }}>
    ...
    <p style={{ color: 'var(--pharos-color-text-20)' }}>
      Carefully select the images to best represent the content of the message. For example, if
      we're promoting ebooks, don't use photos of posters; if we're contacting secondary schools
      don't show images of a large research library.
    </p>
  </div>
  <div>
    <PharosHeading level="3" preset="4">
    ...
    <p style={{ color: 'var(--pharos-color-text-20)' }}>
      Images should reflect our brand framework:
      <br />
      It feels - Dependable, Intriguing, Focused
      <br />
      It looks - Uncomplicated, Composed, Modern
    </p>
    <p style={{ color: 'var(--pharos-color-text-20)' }}>
      Consider the brand color palette when selecting. <br />
      The images should be aesthetically pleasing, as outlined in our brand direction
    </p>
  </div>
</PageSection>
...
<PageSection title="Best Practices">
  <DosAndDonts>
    <ul>
      ...
      <li>
        Select images that fit the space, for example a landscape ortient image for a landing page
        banner
      </li>
  ...
  <DosAndDonts Dont>
    <ul>
      <li>
        Manipulate the image such as changing the color, adding or removing elements, or combining
