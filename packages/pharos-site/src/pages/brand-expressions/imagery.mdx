...
<p style={{ color: 'var(--pharos-color-text-20)' }}>{children}</p>
);
...
>
  <div style={{ marginBottom: 'var(--pharos-spacing-2-x)' }}>
    ...
    <StyledParagraph>
      For global or international campaigns, make sure the people pictured adhere to dress codes of
      most countries (e.g. non-revealing outfits).
    </StyledParagraph>
  </div>
  <div style={{ marginBottom: 'var(--pharos-spacing-2-x)' }}>
    <PharosHeading level="3" preset="4">
  ...
  <div style={{ marginBottom: 'var(--pharos-spacing-2-x)' }}>
    ...
    <StyledParagraph>
      Carefully select images that best represent the content of the message or associated content.
      For example, if we're highlighting eBooks, don't display images of posters; if we're
      contacting secondary schools, don't show images of a large research library.
    </StyledParagraph>
  </div>
  <div>
    <PharosHeading level="3" preset="4">
    ...
    <StyledParagraph>
      ...
      <PharosLink href="/brand-expressions/color" onClick={handleLinkClick}>
        brand color palette
      </PharosLink> when making selections.
    </StyledParagraph>
  </div>
</PageSection>
  ...
  <BestPractices
    Do={
      <ul>
        ...
        <li>
          Select images that fit the space, e.g., a landscape orientation for a landing page banner
        </li>
