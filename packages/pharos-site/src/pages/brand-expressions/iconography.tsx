      ...
      <BestPractices
        Do={
          <ul>
            ...
            <li>
              Limit the creation of icon variations. No need for different icons to represent the
              same concept (e.g. "admin settings" vs. "user settings")
            </li>
          </ul>
        }
        Dont={
    ...
    <div style={{ marginBottom: '4rem' }}>
      ...
      <BestPractices
        ...
        Dont={
          <ul>
            <li>
              Don't reinvent an icon that's already been accepted as a convention. (e.g. a "gear"
              icon for "settings").
            </li>
          </ul>
        }
    ...
    <div style={{ marginBottom: '4rem' }}>
      ...
      <BestPractices
        ...
        Dont={
          <ul>
            <li>
              Icons that aren't related may look out of place, cheapening the design or leading a
              user to mistrust your design.
            </li>
          </ul>
        }
      />
  ...
  <PageSection title="Design and production guidelines">
    ...
    <div style={{ marginTop: '4rem', marginBottom: '5rem', width: '66%' }}>
      ...
      <ol>
        ...
        <li>
          Create a 24x24px rectangle or artboard with a 1px grid. All lines and shapes of the icon
          are to snap to a pixel on the grid, so there shouldn't be any decimal sizes of the lines
          or shapes you create.
        </li>
        <li>
          Then, you'll need to use our grid template. Most product-based icons should be 16px, with
          a max size of 20px. The grid's internal boxes decrease from 24px at 2px increments down to
    ...
    <ul>
      ...
      <li>
        Convert your strokes to outlines, all shapes and paths should be combined and converted into
        a single path.
      </li>
    </ul>
  </PageSection>
