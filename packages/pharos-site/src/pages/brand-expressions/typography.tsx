...
<>
  ...
  <PageSection title="Bodycopy">
    ...
    >
      <strong>GT America</strong> is a grotesque sans serif with more of a human touch than usual in
      the genre, leading to a much better performance in legibility and readability, especially on
      screens.
    </div>
    <PharosHeading level={3} preset="4">
