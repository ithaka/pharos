      ...
      >
        <div style={{ marginBottom: 'var(--pharos-spacing-2-x)' }}>
          ...
          <p style={{ color: 'var(--pharos-color-text-20)' }}>
            Archive images pull from collections on JSTOR (Artstor, Open Community Collections,
            Primary Sources) as well as the diverse content types in them (art, objects, historical
          ...
          <p style={{ color: 'var(--pharos-color-text-20)' }}>
            Images of art or artifacts should represent different cultures and time periods,
            including diversity in the creators (e.g., race, gender, location, etc.). Similarly,
            images of people should be diverse (e.g., representing different demographics and
            abilities).
          </p>
          <p style={{ color: 'var(--pharos-color-text-20)' }}>
            For global or international campaigns, make sure the people pictured adhere to dress
            codes of most countries (e.g. non-revealing outfits).
          </p>
        </div>
        <div style={{ marginBottom: 'var(--pharos-spacing-2-x)' }}>
          <PharosHeading level={3} preset="4">
